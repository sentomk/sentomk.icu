...
const configuration = defineCollection({
  ...
  schema: z.object({
    ...
    personal: z.object({
      ...
      /**
       * The Hacker News profile URL.
       */
      hackerNewsProfile: z.url().optional(),
    }),
    ...
    texts: z.object({
      ...
      seriesName: z.string().default("Series"),
      noSeries: z.string().default("No series found."),
    }),
...
const blog = defineCollection({
  ...
  schema: z
    .object({
      ...
      /**
       * The series slug this post belongs to.
       */
...
/**
 * Loader and schema for the series collection.
 */
...
export const collections = { blog, project, series, configuration };
